...
public class InmueblesDAO {
    ...
    public List<Inmuebles> list_inmu_filtrado(Connection conexion) throws SQLException, ClassNotFoundException, IOException {
        ...
        while (resultado.next()) {
            ...
            a.setPorcentaje_comu(resultado.getInt(15));
            a.setPorcentaje_comu_general(resultado.getInt(16));
            a.setProcentaje(resultado.getInt(17));
    ...
    public void mod_inmuebles(Connection conexion, Inmuebles inmu) throws SQLException, ClassNotFoundException, IOException {
        String sql = "UPDATE gestiones_pisos.inmuebles AS a SET a.inmueble_tipo_id = ?, a.destino = ?, a.domicilio = ?, a.ciudad_id = ?,"
                + "a.codigo_postal = ?, a.alias = ?, a.refcatastral = ?, a.registro_propiedad = ?, a.tomo = ?, a.libro = ?, a.folio = ?, a.finca = ?,"
                + "a.inspeccion = ?, a.porcentaje_comunidad = ?, a.porcentaje_comunidad_general = ? WHERE a.idinmueble = ?;";
        ...
        sentencia.setInt(14, inmu.getPorcentaje_comu());
        sentencia.setInt(15, inmu.getPorcentaje_comu_general());
        sentencia.setInt(16, inmu.getId_inmueble());
        sentencia.executeQuery();
    }
    
    public void mod_relacion_inmu_prop(Connection conexion, Relacion_inmuprop rela)throws SQLException, ClassNotFoundException, IOException{
        String sql = "UPDATE gestiones_pisos.inmuebles_propietarios SET porcentaje_prop = ?, WHERE inmuebles_id = ?";
        
        PreparedStatement sentencia = conexion.prepareStatement(sql);
        sentencia.setInt(1, rela.getPorcentaje());
        sentencia.setInt(2, rela.getId_inmu());
        sentencia.executeQuery();
    }
}
